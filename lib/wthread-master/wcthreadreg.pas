...
type
    ...
    TLazarusHook = class
        ...
        procedure OnPersistentDeleted{$ifdef ver22}(APersistent: TPersistent){$endif};
        {$ifdef ver16}
...
begin
    if APersistent is TWCThread then begin
        ...
        //    GlobalDesignHook.PersistentDeleted{$ifdef ver22}(APersistent){$endif};
...
procedure TLazarusHook.OnPersistentDeleted{$ifdef ver22}(APersistent: TPersistent){$endif};
begin
