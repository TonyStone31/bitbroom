...
type
    ...
    TfrmMain = class(TForm)
        ...
        procedure TaskGenerateReportsFinish(const Sender: TTask;
          const Msg: Word; const Param: Variant);
        procedure TaskGenerateReportsMessage(const Sender: TTask;
          const Msg: Word; const Param: Variant);
        procedure TaskGenerateReportsProgress(const Sender: TTask;
...
procedure TfrmMain.TaskGenerateReportsFinish(const Sender: TTask;
  const Msg: Word; const Param: Variant);
begin

end;

procedure TfrmMain.TaskGenerateReportsMessage(const Sender: TTask;
  const Msg: Word; const Param: Variant);
begin

end;

procedure TfrmMain.TaskGenerateReportsProgress(const Sender: TTask;
  const Msg: Word; const Value: Word);
begin
